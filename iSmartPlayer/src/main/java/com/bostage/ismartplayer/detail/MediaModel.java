...
public class MediaModel implements Parcelable {
    ...
    public static List<MediaModel> getVideoModels() {
        ...
        String contents[] = {
                ...
                "，全称湖南广播电视台卫星频道，昵称芒果台，是湖南广播电视台和芒果传媒有限公司旗下的卫星电视频道。\n" +
                        "1997年1月，湖南电视台第一套节目上星更名为湖南电视台卫星频道。\n" +
                        "2010年1月，湖南广电整合后，呼号更名为“湖南广播电视台卫星频道”。\n" +
                        "2016年4月，湖南卫视推出了“越新鲜越青春”的频道口号。",
        ...
        String videoUrls[] = {
                ...
                "http://live.gslb.letv.com/gslb?stream_id=lb_lb_fajia_1800&tag=live&ext=m3u8&sign=live_tv&platid=10&splatid=1009&format=letv&expect=1",
        };

        for (int i = 0; i < titles.length; i++) {
            MediaModel mediaModel = new MediaModel(
                    0, titles[i], contents[i], urls[i], videoUrls[i], videoUrls[0]);
            mediaModels.add(mediaModel);
        }
